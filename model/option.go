...
import (
	...
	"medusaxd-api/setting/operation_setting"
...
func updateOptionMap(key string, value string) (err error) {
	...
	// Check if it's a model configuration - use a more standardized approach
	if handleConfigUpdate(key, value) {
		return nil // Already handled by configuration system
	}
