...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/migrate_console_setting", controller.MigrateConsoleSetting) // For migration detection of old keys, will be removed in next version
		}
