    ...
    <footer className="relative bg-semi-color-bg-2 h-auto py-16 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full">
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://docs.medusaxd.com/wiki/project-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('关于项目')}</a>
                <a href="https://t.me/medusaXD" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('联系我们')}</a>
                <a href="https://docs.medusaxd.com/wiki/features-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('功能特性')}</a>
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://docs.medusaxd.com/getting-started/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('快速开始')}</a>
                <a href="https://docs.medusaxd.com/installation/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('安装指南')}</a>
                <a href="https://docs.medusaxd.com/api/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('API 文档')}</a>
              </div>
            </div>
            ...
            <div className="text-left">
              <p className="!text-semi-color-text-0 font-semibold mb-5">{t('基于MedusaXD API的项目')}</p>
              <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-[1110px] gap-6">
        ...
        <div className="text-sm">
          ...
          <a href="https://t.me/medusaXD" target="_blank" rel="noopener noreferrer" className="!text-semi-color-primary font-medium">MedusaXD</a>
        </div>
      </div>
    </footer>
