...
const LoginForm = () => {
  ...
  // Add Telegram login handler function
  ...
  // Wrapped GitHub login click handler
  const handleGitHubClick = () => {
    setGithubLoading(true);
    try {
      onGitHubOAuthClicked(status.github_client_id);
    } finally {
      // Due to redirect, this won't execute, but added for completeness
      setTimeout(() => setGithubLoading(false), 3000);
    }
  };

  // Wrapped OIDC login click handler
  ...
  // Wrapped LinuxDO login click handler
  ...
  // Wrapped email login option click handler
  ...
  // Wrapped reset password click handler
  ...
  // Wrapped other login options click handler
