...
import (
	...
	"medusaxd-api/relay/channel/ai360"
	"medusaxd-api/relay/channel/lingyiwanwu"
	"medusaxd-api/relay/channel/minimax"
	"medusaxd-api/relay/channel/moonshot"
	"medusaxd-api/relay/channel/openrouter"
	"medusaxd-api/relay/channel/xinference"
	relaycommon "medusaxd-api/relay/common"
	"medusaxd-api/relay/common_handler"
...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	case constant.ChannelTypeAzure:
		...
		// https://github.com/songquanpeng/medusaxd-api/issues/67
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		header.Set("X-Title", "MedusaXD API")
	}
	return nil
}
